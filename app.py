...
def search():
    ...
    if form.validate_on_submit():
        ...
        users = User.query.filter(User.full_name.contains(search) | User.email.contains(search) | User.course.contains(search) | User.department.contains(search) | User.hostel.contains(search))
